...
(function (window) {
    ...
    var option = {
        ...
        prevcolors: ["#D81B43", "#8E24AA", "#512DA8", "#2B378C", "#1D86E4", "#00897B", "#43A047", "#FBC02D", "#F57C00", "#E64A19", "#E91E4E", "#9C27B0", "#673AB7", "#3949AB", "#2196F3", "#009688", "#4CAF50", "#FDD835", "#FB8C00", "#F4511E", "#EC4064", "#AB47BC", "#7E58CD", "#5C6BC0", "#42A5F5", "#26A69A", "#81C784", "#FFEB3B", "#FFA726", "#FF5722", "#F0627D", "#BA68C8", "#9271D5", "#7986CB", "#64B5F6", "#80CBC4", "#A5D6A7", "#FFF176", "#FFB74D", "#FF8A65", "#F48FA0", "#CE93D8", "#AA8ED7", "#9FA8DA", "#90CAF9", "#B2DFDB", "#C8E6C9", "#FFF59D", "#FFCC80", "#FFAB91", "#00000000", "#FFFFFF", "#E0E0E0", "#B6B6B6", "#999999", "#808080", "#666666", "#333333", "#1A1A1A", "#000000"],//预制颜色
...
<!--            <p>预置颜色</p>-->
            ...
            <div class="color-btns">
                <div class="color-preview">
                    ...
                    <div class="current-colorBox"><div class="current-color"></div></div>
